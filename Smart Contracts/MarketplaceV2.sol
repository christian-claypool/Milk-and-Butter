...
contract MBNFTMarket is Ownable, ReentrancyGuard {
    ...
    //Tokens
    IERC20 MB = IERC20(0x8d552B76Cdf1f5AccB5ea6D715EbcD5E11df1EC9);
    address payable _USDTAddress = payable(0x2F02f77c2bA5A7cE4924f2a1E5Ecc85580fDD096);
    ...
    constructor () {
        ...
        tokens[0].token = IERC20(0x8d552B76Cdf1f5AccB5ea6D715EbcD5E11df1EC9);
        tokens[0].fees = 0;
        tokens[0].wbnbLPaddress = 0xe72c06a1cc3b360476F5758e25dc4ACe5f354273;
        tokens[0].decimals = 9;
    }
